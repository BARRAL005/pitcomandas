...
import { Comanda, ActivityLog } from '../types';
...
export default function CaixaView({ comandas, paidComandas, addActivityLog }: CaixaViewProps) {
  ...
  // Custom manual cash additions (suprimentos / sangrias)
  const [manualTransactions, setManualTransactions] = useState<RegisterTransaction[]>([
    { id: 't1', type: 'entrada', tag: 'suprimento', title: 'Abertura de Caixa', value: 350.00, timestamp: '17:30', method: 'Dinheiro' },
    { id: 't2', type: 'saida', tag: 'sangria', title: 'Sangria de segurança', value: 100.00, timestamp: '19:45', method: 'Dinheiro' },
    { id: 't3', type: 'saida', tag: 'despesa', title: 'Compra de Gelo em Cubo', value: 32.00, timestamp: '20:00', method: 'Dinheiro' }
  ]);
  ...
  const handleAddFlow = (e: React.FormEvent) => {
    ...
    setManualTransactions([newTr, ...manualTransactions]);
    addActivityLog(
      'close_register', 
